...
### Task Dependencies
Task dependencies are set using the `set_upstream()` and `set_upstream()`. Using either will depend on your preferences, but it is best to stay consistent with which one you use.
