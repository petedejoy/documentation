...
Let's walk through gameplay to show exactly how those events are tracked and logged. We have connected this client-side event tracking to [Keen.io](v2/clickstream/destinations/keen-io.html), which then records events in the panels on the right hand side of the page. 
